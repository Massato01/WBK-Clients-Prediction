...
COPY public.CLIENTES (idcliente, cliente, estado, sexo) FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2865.dat';
...
COPY public.ESTADOCIVIL ("IDESTADOCIVIL", "ESTADOCIVIL") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2863.dat';

-- Data for Name: FIADOR; Type: TABLE DATA; Schema: public; Owner: postgres
--COPY public."FIADOR" ("IDFIADOR", "FIADOR") FROM stdin;
COPY public.FIADOR ("IDFIADOR", "FIADOR") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2861.dat';
...
COPY public.HABITACAO ("IDHABITACAO", "HABITACAO") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2857.dat';
...
COPY public.HISTORICO_CREDITO ("IDHISTCRED", "HISTORICO") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2855.dat';
...
COPY public.INVESTIMENTOS ("IDINVESTIMENTOS", "INVESTIMENTOS") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2860.dat';
...
COPY public.OUTROSFINANC ("IDOUTROSFINANC", "OUTROSFINANCIAMENTOS") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2862.dat';
...
COPY public.PROFISSAO ("IDPROFISSAO", "PROFISSAO") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2859.dat';
...
COPY public.PROPOSITO ("IDPROPOSITO", "PROPOSITO") FROM 'C:\Users\massa\Desktop\WBK\backupcredito\2856.dat';
